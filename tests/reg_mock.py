...
from Registry.Registry import RegistryValueNotFoundException, RegistryKeyNotFoundException
from Registry.Registry import RegSZ, RegExpandSZ, RegBin, RegDWord, RegMultiSZ, RegQWord, RegNone, RegBigEndian, RegLink, RegResourceList, RegFullResourceDescriptor, RegResourceRequirementsList
