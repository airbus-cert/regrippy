...
@pytest.fixture
def mock_reg_seven():
    key = RegistryKeyMock.build("Software\\Microsoft\\Windows\\CurrentVersion\\Explorer\\UserAssist")
    ...
    notepad = RegistryValueMock(
        ...
        bytearray([0x00,0x00,0x00,0x00,0x06,0x00,0x00,0x00,0x05,0x00,0x00,0x00,0x60,0xea,0x00,0x00,0x00,0x00,0x80,0xbf,0x00,0x00,0x80,0xbf,0x00,0x00,0x80,0xbf,0x00,0x00,0x80,0xbf,0x00,0x00,0x80,0xbf,0x00,0x00,0x80,0xbf,0x00,0x00,0x80,0xbf,0x00,0x00,0x80,0xbf,0x00,0x00,0x80,0xbf,0x00,0x00,0x80,0xbf,0xff,0xff,0xff,0xff,0x02,0xd2,0x7e,0xce,0xb4,0xbf,0xd4,0x01,0x00,0x00,0x00,00]),
        RegBin
    )
...
def mock_reg_xp():
    ...
    notepad = RegistryValueMock(
        ...
        bytearray([0x01,0x00,0x00,0x00,0x08,0x00,0x00,0x00,0xc0,0x66,0x16,0xce,0xa4,0xce,0xd4,0x01]),
        RegBin
    )
    count.add_value(notepad)
...
def test_userassist_win7(mock_reg_seven):
    ...
    assert("userassist" in results[0].custom.keys()), "A 'userassist' object should have been created"
